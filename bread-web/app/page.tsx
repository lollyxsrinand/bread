export default function Page() {
  return (
    <div className='h-screen w-full flex items-center justify-center'>
      <div className="h-fit w-64 flex flex-col gap-5 justify-center items-center p-5">
        ...
        <div>
         ...
         <div className="flex flex-col gap-2.5 w-full items-center justify-center text-center">
           <a className="button w-full hover:bg-white hover:text-black" href="/login">login</a>
           {process.env.NODE_ENV === "production" && <p className="text-neutral-600">nah the button wont work we{`'`}re still making it</p>}
         </div>
      </div>
    </div>
  );
